...
# Создаем класс солнечной системы
...
class SolarSystem:
    ...
    # Создадим метод для добваления планеты
...
# Создаем экземпляры класса Солнечной системы и добавляем туда Солнце
...
# Добавляем планеты в нашу солнечную систему
...
# Анимируем нашу солнечную систему
def animate(i):
    return ss.evolve()
